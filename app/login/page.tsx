    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #f0f0ff 0%, #faf5ff 50%, #f0fdf4 100%)", padding: "24px" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>Team Task Manager</p>
        </div>

        <div style={{ background: "#fff", borderRadius: 16, border: B, padding: 36, boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: "#0f172a", marginBottom: 6, letterSpacing: "-0.3px" }}>Welcome back</h1>
          <p style={{ fontSize: 14, color: "#64748b", marginBottom: 28 }}>Sign in to continue to TaskFlow</p>

          {error && (
            <div style={{ marginBottom: 16, background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 8, padding: "10px 14px", fontSize: 13, color: "#dc2626" }}>
              {error}
            </div>
          )}
          ...
          <div style={{ marginTop: 24, padding: "12px 16px", background: "#f0f9ff", border: "1px solid #bae6fd", borderRadius: 8 }}>
            <p style={{ fontSize: 13, color: "#0369a1", margin: 0, lineHeight: 1.5 }}>
              <strong>Note:</strong> Email/password authentication is temporarily disabled. Please use Google to sign in.
            </p>
          </div>
        </div>
